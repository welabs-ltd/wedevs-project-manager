        ...
        <form v-on:submit.prevent="listFormAction()" action="" method="post">
            ...
            <div class="item milestone">
                <select class="milestone-field" v-model="milestone_id">
                    ...
                    <option v-for="milestone in milestones" :value="milestone.id" :key="milestone.id" v-html="milestone.title"></option>
                </select>
            </div>
            ...
            <div class="item submit">
                <a @click.prevent="showHideListForm(false, list)" class="pm-button pm-secondary cancel-btn" href="#">{{__( 'Cancel', 'wedevs-project-manager')}}</a>
